...
public class UserManagementServiceImpl implements UserManagementService {
	...
	public AddUserResponse addUser(AddUserRequest request) {
		...
		if(receivedData.isEmpty()) {
			...
			Users userTable = Users.getInstance().setUserName(request.getUserName())
					.setPassword(encryptAES(request.getPassword(), aesKey)).setEmail_id(request.getEmailId())
					.setAge(request.getAge()).setUserId(request.getUserId()).setAesKey(aesKey);
